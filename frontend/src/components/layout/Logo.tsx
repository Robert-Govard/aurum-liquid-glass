/**
 * Moneta's mark: a coin with an "M" monogram. Rendered as inline SVG (not the
...
export function Logo({ size = 24, className }: LogoProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 32 32" className={className} aria-hidden="true">
      <defs>
        <linearGradient id="monetaCoin" x1="5" y1="4" x2="27" y2="28" gradientUnits="userSpaceOnUse">
          <stop offset="0" stopColor="#f7d488" />
          <stop offset="0.55" stopColor="#eda100" />
          <stop offset="1" stopColor="#a8690a" />
        </linearGradient>
      </defs>
      <circle cx="16" cy="16" r="14.5" fill="url(#monetaCoin)" stroke="#7a4e08" strokeWidth="1.2" />
